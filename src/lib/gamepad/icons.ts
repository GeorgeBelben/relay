import { ControllerType, NavAction, NavDirection } from "./types";
...
export function getGamepadIconUrl(controllerType: ControllerType, key: HintKey): string {
  return CONTROLLER_ICON_SETS[controllerType][key];
}
